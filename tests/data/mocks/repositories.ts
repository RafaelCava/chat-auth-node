  ...
  implements FindUserByEmailRepository, Spy
{
  ...
  result: FindUserByEmailRepository.Result = {
...
export class FindRoomByNameRepositorySpy
  implements FindRoomByNameRepository, Spy
{
...
export class CreateRoomRepositorySpy
  implements
    CreateRoomRepository,
    Spy<CreateRoomRepository.Params, CreateRoomRepository.Result>
{
  params: Room;
...
export class FindRoomsRepositorySpy
  implements
    FindRoomsRepository,
    Spy<FindRoomsRepository.Params, FindRoomsRepository.Result>
{
