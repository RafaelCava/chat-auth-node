...
describe("Authentication Usecase", () => {
  it("Should be defined", () => {
    const { sut, encrypterSpy, findUserByEmailRepositorySpy, hashComparerSpy } =
      makeSut();
  ...
  it("Should call FindUserByEmailRepository with correct email", async () => {
    ...
    expect(findUserByEmailRepositorySpy.params).toEqual({
      email: params.email,
  ...
  it("Should throw if FindUserByEmailRepository throws", async () => {
    const { sut, findUserByEmailRepositorySpy, encrypterSpy, hashComparerSpy } =
      makeSut();
  ...
  it("Should call HashComparer with correct values", async () => {
    ...
    expect(hashComparerSpy.params).toEqual({
      ...
      hash: findUserByEmailRepositorySpy.result.password,
    });
  ...
  it("Should call Encrypter with correct value", async () => {
    ...
    expect(encrypterSpy.params).toEqual({
      value: findUserByEmailRepositorySpy.result.id,
      expiresIn: "2d",
    });
